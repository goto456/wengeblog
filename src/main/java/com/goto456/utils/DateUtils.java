...
public class DateUtils {
	...
	public static int getIntervalDays(Date date, Date otherDate) {
		int num = -1;
		Date dateTmp = StringToDate(DateUtils.getDate(date), DateStyle.YYYY_MM_DD);
		Date otherDateTmp = StringToDate(DateUtils.getDate(otherDate), DateStyle.YYYY_MM_DD);
